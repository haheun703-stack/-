...
SECTOR_ETFS = {
    ...
    # 그룹형 (5/14 확장: LG/한화/포스코/두산/SK하이닉스/삼성KODEX/현대차채권)
    "삼성그룹": ("138520", "TIGER 삼성그룹", "group"),
    "삼성그룹_KODEX": ("102780", "KODEX 삼성그룹", "group"),
    "LG그룹": ("138530", "TIGER LG그룹플러스", "group"),
    "현대차그룹": ("138540", "TIGER 현대차그룹플러스", "group"),
    "현대차그룹채권": ("492500", "1Q 현대차그룹채권", "group_bond"),
    "한화그룹": ("0000J0", "PLUS 한화그룹주", "group"),
    "포스코그룹": ("469170", "ACE 포스코그룹포커스", "group"),
    "두산그룹": ("0177A0", "WON 두산그룹포커스", "group"),
    "SK하이닉스밸류체인": ("494220", "UNICORN SK하이닉스밸류체인액티브", "theme"),
    # 시장 대표
