...
RSS_FEEDS = [
    ...
    # --- 3대 매크로 이벤트 모니터링 ---
    (_google_rss("케빈워시 연준 의장 금리 통화정책"), "연준_워시"),
    (_google_rss("FOMC 금리인하 금리인상 기준금리 연준"), "금리정책"),
    (_google_rss("이란 전쟁 공습 중동 유가 원유 호르무즈"), "이란_유가"),
    (_google_rss("방산주 한화에어로스페이스 LIG넥스원 현대로템"), "방산수혜"),
    (_google_rss("정유주 유가상승 S-Oil SK이노베이션"), "정유수혜"),
    # --- 섹터별 뉴스 (신규) ---
...
HIGH_IMPACT_KEYWORDS = [
    ...
    "상한가", "하한가", "거래정지", "상장폐지",
    # 3대 매크로 이벤트 키워드
    "케빈워시", "워시", "Warsh", "연준의장", "Fed의장", "통화정책",
    "이란", "공습", "호르무즈", "중동전쟁", "유가급등", "배럴",
    "금리동결", "금리인상", "금리인하", "빅컷", "자이언트스텝",
    "대차대조표", "양적완화", "양발운전",
]
...
MEDIUM_IMPACT_KEYWORDS = [
    ...
    "테마주", "급등", "신고가", "돌파",
    # 3대 매크로 이벤트 보조 키워드
    "연준", "Fed", "매파", "비둘기", "NIM", "이자마진",
    "정유", "정제마진", "나프타", "브렌트", "WTI",
    "한화에어로", "LIG넥스원", "현대로템", "퍼스텍", "한화시스템",
    "S-Oil", "SK이노", "GS칼텍스", "리츠", "REIT", "부동산펀드",
    "KB금융", "신한지주", "하나금융", "삼성화재", "DB손보",
    "항공유", "항공주", "대한항공", "연료비",
]
