...
KR_HOLIDAYS_2026 = {
    ...
    date(2026, 3, 1),   # 삼일절
    date(2026, 5, 1),   # 근로자의날 (증시 휴장, 법정공휴일 아니라 누락됐던 것 — 2026-06-05 추가)
    date(2026, 5, 5),   # 어린이날
    date(2026, 5, 24),  # 석가탄신일
    date(2026, 6, 3),   # 제9회 전국동시지방선거 (임시공휴일) — 2026-06-04 추가
    date(2026, 6, 6),   # 현충일
    date(2026, 8, 15),  # 광복절
    ...
    date(2026, 5, 25),  # 석가탄신일 대체공휴일 (월) — 5/24 일요일 겹침, 2023년부터 시행
